...
import static top.srintelligence.wallpaper_generator.lookup_kernel.exception.ExceptionHandler.handleDebug;
import static top.srintelligence.wallpaper_generator.lookup_kernel.exception.ExceptionHandler.handleException;
import static top.srintelligence.wallpaper_generator.lookup_kernel.process.net.util.NetworkUtil.isConnected;
